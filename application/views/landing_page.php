...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo base_url().'assets/'?>landing/assets/https://fonts.googleapis.com/css?family=Raleway:100,300,400,500,700,900" rel="stylesheet">
...
-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/'?>landing/assets/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/'?>landing/assets/css/font-awesome.css">

    <link rel="stylesheet" href="<?php echo base_url().'assets/'?>landing/assets/css/templatemo-softy-pinko.css">
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">
                          <h3 class="text-center">Angkringan</h3>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="#welcome" class="active"><span class="fa fa-home"></span>&nbspHome</a></li>
                            <li><a href="#features"><span class="fa fa-info-circle">&nbspAbout</a></li>
                            <li><a href="#work-process"><span class="fa fa-cogs">&nbspWork Process</a></li>
                            <li><a href="#testimonials"><span class="fa fa-tasks">&nbspTestimonials</a></li>
                            <li><a href="#pricing-plans"><span class="fa fa-receipt">&nbspPricing Tables</a></li>
                            <li><a href="#blog"><span class="fa fa-table">&nbspBlog Entries</a></li>
                            <li><a href="#contact-us"><span class="fa fa-address-card">&nbspContact Us</a></li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                        ...
                        <h1><span class="fa fa-store-alt"></span>&nbspANGKRINGAN  <strong></strong><br> <strong></strong></h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="icon">
                                    <i><img src="<?php echo base_url().'assets/'?>landing/assets/images/featured-item-01.png" alt=""></i>
                                </div>
                                <h5 class="features-title">Strategi Modern</h5>
                                <p>Sesuaikan apa pun di templat ini agar sesuai dengan kebutuhan situs web Anda</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.4s">
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">Hubungan Terbaik </h5>
                                <p>Hubungi kami segera jika Anda memiliki pertanyaan</p>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.6s">
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">Pemasaran Utama</h5>
                                <p>Anda hanya perlu memberi tahu teman Anda tentang template gratis kami</p>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="<?php echo base_url().'assets/'?>landing/assets/images/left-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="left-heading">
                        <h2 class="section-title">Mari kita bahas tentang proyek Anda</h2>
                    </div>
                    <div class="left-text">
                        <p>Nullam sit amet purus libero. Etiam ullamcorper nisl ut augue blandit, di finibus leo efficitur. Nam gravida purus non sapien auctor, ut aliquam magna ullamcorper.</p>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="<?php echo base_url().'assets/'?>landing/assets/images/right-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <a href="#" class="mini-box">
                            <i><img src="<?php echo base_url().'assets/'?>landing/assets/images/work-process-item-01.png" alt=""></i>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <a href="#" class="mini-box">
                            <i><<?php echo base_url().'assets/'?>landing/="<?php echo base_url().'assets/'?>landing/assets/images/work-process-item-01.png" alt=""></i>
